      ...
      <div className="grid gap-4 md:grid-cols-2">
            ...
            {activeVouchers.length > 0 ? (
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground text-center mt-3">
                  Kuponu kullanmak için tıklayın
                </p>
              </div>
            ) : (
              <div className="text-center py-6 text-muted-foreground">
                ...
                <p className="text-sm mt-2">
                  Aktivitelere katılarak kupon kazanabilirsiniz!
                </p>
              </div>
            )}
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              6 aktiviteye katılın, 1 kahve kazanın!
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {(profile?.activity_attendance_count || 0) % 6} / 6 Aktivite
                </span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="text-center p-3 bg-muted/50 rounded-lg">
                ...
                <p className="text-2xl font-bold">
                  {profile?.activity_attendance_count || 0}
                </p>
              ...
              <div className="text-center p-3 bg-muted/50 rounded-lg">
                ...
                <p className="text-2xl font-bold">
                  {profile?.coffee_voucher_count || 0}
                </p>
                <p className="text-xs text-muted-foreground">
                  Kazanılan Kupon
                </p>
            ...
            {activitiesToNextVoucher < 6 && (
              <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <p className="text-sm text-center">
                  <span className="font-medium">{activitiesToNextVoucher}</span> aktiviteye 
                  daha katıldığınızda yeni bir kahve kuponu kazanacaksınız!
                </p>
              </div>
            )}
          </CardContent>
            ...
            <div className="space-y-4">
              <div className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-lg text-center">
                ...
                <Badge className="mb-4">
                  {reasonLabels[selectedVoucher.reason].label}
                </Badge>
              ...
              <div className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg">
                ...
                <p className="text-sm">
                  Kupon otomatik olarak hesabınıza tanımlanmıştır.
                </p>
              </div>
            </div>
          </DialogContent>
